...
export default function Footer(){
    return(
        <div className="footer" style={{color:'whitesmoke', textDecoration:'none', textAlign:'center', padding:'30px'}}>
            ...
            <a href="https://goo.gl/maps/wYrJmDbJmGzAPWTq8" target="_blank" rel="noreferrer" style={{textDecoration:'none', color:'whitesmoke'}}> 449 N State Rd #101, Briarcliff Manor, NY 10510</a>
        </div>
    )
}